        ...
        <div className='w-[90%] p-10 rounded-3xl mx-auto max-w-full mt-20 bg-gray-800' id='experience'>
            ...
            <ol class="relative border-s border-gray-700 mt-10">
                <li class="mb-10 ms-6 px-3">
                    ...
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-white">React Js Developer - Intership <span class=" text-sm font-medium me-2 px-2.5 py-0.5 rounded bg-blue-900 text-blue-300 ms-3">Latest</span></h3>
                ...
                <li class="mb-10 ms-6 px-3">
                    ...
                    <h3 class="mb-1 text-lg font-semibold text-white">UI Designer</h3>
                    ...
                    <p class="mb-4 text-base font-normal text-justify text-gray-400 indent-10 mt-5">Collaborated with team members to design website layouts and user interaction designs using Figma. Independently
                ...
                <li class="ms-6 px-3">
                    ...
                    <h3 class="mb-1 text-lg font-semibold text-white">Front End Developer</h3>
